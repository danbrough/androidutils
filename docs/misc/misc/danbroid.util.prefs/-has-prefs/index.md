//[misc](../../index.md)/[danbroid.util.prefs](../index.md)/[HasPrefs](index.md)



# HasPrefs  
 [androidJvm] interface [HasPrefs](index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="danbroid.util.prefs/HasPrefs/prefs/#/PointingToDeclaration/"></a>[prefs](prefs.md)| <a name="danbroid.util.prefs/HasPrefs/prefs/#/PointingToDeclaration/"></a> [androidJvm] abstract val [prefs](prefs.md): [SharedPreferences](https://developer.android.com/reference/kotlin/android/content/SharedPreferences.html)   <br>
