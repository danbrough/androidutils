...
# Prefs  
 [androidJvm] open class [Prefs](index.md)(**context**: [Context](https://developer.android.com/reference/kotlin/android/content/Context.html), **fileName**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))
...
| <a name="danbroid.util.prefs/Prefs/fileName/#/PointingToDeclaration/"></a>[fileName](file-name.md)| <a name="danbroid.util.prefs/Prefs/fileName/#/PointingToDeclaration/"></a> [androidJvm] val [fileName](file-name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
