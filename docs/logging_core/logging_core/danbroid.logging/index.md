...
|  Name |  Summary | 
|---|---|
| <a name="danbroid.logging/DBLog///PointingToDeclaration/"></a>[DBLog](-d-b-log/index.md)| <a name="danbroid.logging/DBLog///PointingToDeclaration/"></a>[jvm]  <br>Content  <br>abstract class [DBLog](-d-b-log/index.md)  <br><br><br>|
