...
# AndroidLog  
 [jvm] class [AndroidLog](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Log](../-log/index.md)   
...
|  Name |  Summary | 
|---|---|
| <a name="danbroid.logging/AndroidLog/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="danbroid.logging/AndroidLog/name/#/PointingToDeclaration/"></a> [jvm] open override val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>|
