//[logging](../../../index.md)/[danbroid.logging](../index.md)/[NullLog](index.md)



# NullLog  
 [jvm] object [NullLog](index.md) : [Log](../-log/index.md)   
...
|  Name |  Summary | 
|---|---|
| <a name="danbroid.logging/NullLog/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="danbroid.logging/NullLog/name/#/PointingToDeclaration/"></a> [jvm] open override val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>|
